...
const ENTITY_OPTIONS = {
  ...
  'process_engine.ProcessType': { label: 'Process Types', module: 'process_management', route: '/admin-console', fields: ['id', 'code', 'name', 'category', 'remarks'] },
  'process_engine.ProcessInstance': { label: 'Process Executions', module: 'process_management', route: '/process-management', fields: ['id', 'status', 'remarks', 'process_type__name', 'process_type__code'] },
